...
@section('content')
    <div class="space-y-6">
        @include('admin.partials.hero', [
            ...
            'title' => 'Edit User',
            'subtitle' => 'Perbarui profil, role, dan kredensial user.',
        ])
        ...
        <x-admin.module class="mx-auto max-w-2xl" body-class="p-6">
            <form method="POST" action="{{ route('admin.users.update', $targetUser->id) }}" class="space-y-4">
                ...
                <div>
                    <label class="mb-1 block text-xs font-semibold text-slate-700">New Password (Optional)</label>
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="rounded-xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100">Back</a>
                </div>
            </form>
        </x-admin.module>
    </div>
